...
public class AmpereOnFocusChangeListener implements OnFocusChangeListener {

	private final EditText editText;

	public AmpereOnFocusChangeListener(EditText editText) {
		super();
	...
	public void onFocusChange(View v, boolean hasFocus) {
		if (hasFocus) {
			...
			if (editText.getText().length() > 0) {
				editText.setText(Calculations.validateStringInput(editText
						.getText().toString())
						+ v.getContext().getResources().getString(R.string._a));
			}
		}
	}
}
